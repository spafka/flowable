...
import io.github.spafka.flowable.service.multiinstance.MulitiInstanceCompleteTask;
...
public class multiInstanceBackTests2 extends FlowBase {
    ...
    public void okshould_case1() {
        ...
        MulitiInstanceCompleteTask.taskThreadLocal.set(task1);
