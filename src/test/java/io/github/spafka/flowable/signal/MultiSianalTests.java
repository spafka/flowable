...
public class MultiSianalTests extends FlowBase {

    private static final String key = "K4187597187930913";
    ...
    public void deploy() {
        Deployment deployment = repositoryService.createDeployment()
                .addClasspathResource("signal/K4187597187930913.bpmn20.xml")
                .name(processName)
                .key(key)
    ...
    public void submit() {
        ...
        List<Execution> list1 = runtimeService.createExecutionQuery().list();
